...
// macOS 适配版本：替换 FFRT 为 std::thread，Mock DistributedCameraSourceService
...
#include "distributed_camera_constants.h"  // 包含常量定义

// macOS 不支持 prctl，使用条件编译
#ifdef __linux__
#include <sys/prctl.h>
#endif
